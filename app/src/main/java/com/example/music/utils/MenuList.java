...
import com.example.music.control.Result;
import com.example.music.domain.MusicInfo;
import com.example.music.domain.MusicList;
import com.example.music.domain.MusicListInfo;
...
public class MenuList {
    ...
    public static List<com.example.music.domain.MusicListInfo> sMusicListInfo;
    ...
    private void updateInfo() {
        ...
        for (int i = 0; i < sCount; i++) {
            final com.example.music.domain.MusicListInfo mMusicListInfo = new com.example.music.domain.MusicListInfo();
