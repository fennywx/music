package com.example.music.control;
...
import com.example.music.interfaces.IPlayerController;
import com.example.music.interfaces.IPlayerViewController;
import com.example.music.service.PlayService;
import com.example.music.utils.DlCRUD;
import com.example.music.utils.LikeCRUD;
import com.example.music.utils.MenuList;


import java.io.File;

import static com.example.music.interfaces.IPlayerController.PLAY_STATE_PAUSE;
import static com.example.music.interfaces.IPlayerController.PLAY_STATE_START;
import static com.example.music.interfaces.IPlayerController.PLAY_STATE_STOP;
...
public class Player extends AppCompatActivity {
    ...
    private com.example.music.domain.MusicListInfo mMusicInfo;
    ...
    private void initView() {
        ...
        mLike = (ImageView)findViewById(R.id.player_like);
        mDownload = (ImageView)findViewById(R.id.player_download);
        mComment = (ImageView)findViewById(R.id.player_comment);
        mLast = (ImageView)findViewById(R.id.player_last);
        mNext = (ImageView)findViewById(R.id.player_next);
    ...
    private com.example.music.interfaces.IPlayerViewController mPlayerViewController = new IPlayerViewController() {
        ...
        public void onPlayStateChange(int state) {
            switch (state){
                case PLAY_STATE_START:
                    mRotation.resume();
                    mSp.setBackgroundResource(R.drawable.ic_action_pause);
                    break;
                case PLAY_STATE_PAUSE:
                    mRotation.pause();
                    mSp.setBackgroundResource(R.drawable.ic_action_playing);
                    //设置暂停
